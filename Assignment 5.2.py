...
def censor(message,censor):
  message = message.replace(censor,("*"*len(censor)))
  return message
...
def main():
  ...
  print(censor('applesauce is made from apples yet johnny appleseed brought no apples just snapple', 'apple'))
